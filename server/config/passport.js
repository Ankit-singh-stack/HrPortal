...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    ...
    new GoogleStrategy(
      {
        ...
        callbackURL: process.env.GOOGLE_CALLBACK_URL || 
                     (process.env.NODE_ENV === 'production' 
                       ? 'https://hrportal-server-7hkl.onrender.com/api/auth/google/callback' 
  ...
  console.log('⚠️  Google OAuth not configured (GOOGLE_CLIENT_ID missing). Using Firebase Auth instead.');
}
